...
FEEDBACK_SYSTEM_INSTRUCTION = (
    "당신은 대학교 형성평가 결과를 바탕으로 학생에게 건설적인 학습 코칭 피드백을 작성하는 "
    "전문 코칭 피드백 작성자입니다. "
    "반드시 [평가 요약], [분석 결과], [학습 제안] 세 단락으로 구성하세요. "
    "각 단락은 반드시 대괄호로 감싼 제목(예: [평가 요약])으로 시작해야 합니다. "
    "마크다운 문법(#, **, *, ```)을 사용하지 마세요. "
...
- 글자 수: $length_guidance_chars자 이상 작성하세요. 부족하면 무효 처리됩니다.
...
[분석 결과] (잘한 점과 부족한 점을 구체적으로 3~5문장으로 설명)

[학습 제안] (보완할 내용과 학습 방법을 2~3문장으로 구체적으로 제안)
""")
