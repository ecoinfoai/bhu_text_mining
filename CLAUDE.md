...
- Python >=3.11, <4 + ReportLab >=4.4.4, matplotlib >=3.10.0, PyYAML >=6.0, networkx >=3.4.2, numpy <2.1.0, sentence-transformers (ko-sroberta-multitask), google-genai (Gemini API) (022-domain-delivery-v3)
...
- 022-domain-delivery-v3: Added Python >=3.11, <4 + ReportLab >=4.4.4, matplotlib >=3.10.0, PyYAML >=6.0, networkx >=3.4.2, numpy <2.1.0, sentence-transformers (ko-sroberta-multitask), google-genai (Gemini API)
